                    ...
                    <form method="POST" action="{{ route('drugs.store') }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea id="description" name="description" rows="3" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500">{{ old('description') }}</textarea>
                            ...
                            <div>
                                ...
                                <x-text-input id="low_stock_threshold" name="low_stock_threshold" type="number" min="1" class="mt-1 block w-full" :value="old('low_stock_threshold', 10)" required />
                            ...
                            <div>
                                ...
                                <x-text-input id="batch_number" name="batch_number" type="text" class="mt-1 block w-full" :value="old('batch_number')" />
